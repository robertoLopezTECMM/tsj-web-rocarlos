...
export default function PerfilCarrera({ ingreso, egreso, photoLink }) {
  const [perfilIndex, setPerfilIndex] = useState(0); // 0: ingreso, 1: egreso
  const [paginaIndex, setPaginaIndex] = useState(0); // para paginación interna
  ...
  // Definir cuántos puntos por página para cada perfil
  const puntosPorPagina = [5, 3];
